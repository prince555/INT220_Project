		...
		<div class="container-fluid">
			...
			<br />
				...
				<form action = "" method = "POST" enctype="multipart/form-data">
					  ...
					  <div class="form-group">
					    <label for="inputdefault">Car Operator Name:</label>
					  ...
					  <div class="form-group">
					    ...
					    <select name = "bC" class = "btn-lg" style = "width:250px;">
					    	<option <?php if($bcpcty == '15 Persons'){echo 'selected';} ?> value = "2 Persons">2 Persons</option>
					    	<option <?php if($bcpcty == '25 Persons'){echo 'selected';} ?> value = "4 Persons">4 Persons</option>
					    	<option <?php if($bcpcty == '30 Persons'){echo 'selected';} ?> value = "6 Persons">6 Persons</option>
					    </select>
					  </div>
