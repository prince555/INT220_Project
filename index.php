		...
		<div class="row">
			<div id="carousel-id" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					<div class="item">
						<center>
						<img src="img/1a.jpg" style="height: 100vh; width: 100%;">
						</center>
						<div class="container">
					...
					<div class="item">
						<img src="img/2a.jpg" style="height: 100vh; width: 100%;">
						<div class="container">
							<div class="carousel-caption">
								<h1>#Summer</h1>
					...
					<div class="item active">
						<img src="img/3a.jpg" style="height: 100vh; width: 100%;">
						<div class="container">
							<div class="carousel-caption">
								<h1>New Car Model.</h1>
		...
		<div class="row container-fluid">
			<div class="col-md-4">
				<div class="panel panel-info">
					...
					<div class="panel-body">
						The Tourism Office is located at Andhra Pradesh India. We offer Luxury cars 
						to rent we also offer affordable lodging right in the town center.
					</div>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="panel panel-success">
					...
					<div class="panel-body">
						...
						email : princepinnu55.com
						mobile : +91 6303822413
					</div>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="panel panel-warning">
					<div class="panel-heading">
						<h3 class="panel-title"><center>Special Offers</center></h3>
					</div>
					<div class="panel-body">
						No Offers available.
					</div>
